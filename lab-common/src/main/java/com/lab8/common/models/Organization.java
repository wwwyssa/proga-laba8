...
public class Organization implements Validatable, Serializable {
     ...
     */
    public Organization(long id, String name, Integer employeesCount, OrganizationType type, Address officialAddress) {
        this.id = id; // id будет сгенерирован автоматически
        this.name = name;
